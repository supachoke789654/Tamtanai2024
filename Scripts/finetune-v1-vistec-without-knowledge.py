...
MODEL_NAME_OR_PATH = "/project/lt200301-edubot/Capstone-TamTanai/models/Meta-Llama-3.1-8B"
DATASET_PATH = "../asset/dataset/dataset.csv"
VISTEC_DATASET_PATH = "../asset/dataset/WangchanThaiInstruct_7.24.parquet"
FINETUNED_MODEL_NAME = "Meta-Llama-3.1-8B-finetune-dataset-v1-vistec-without-knowledge"
...
print("Train set shape:", train_data.shape[0] + vistec_data.shape[0])
