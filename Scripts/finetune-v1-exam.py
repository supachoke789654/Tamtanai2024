...
MODEL_NAME_OR_PATH =  "/project/lt200301-edubot/Capstone-TamTanai/models/Pathumma-llm-text-1.0.0"
DATASET_PATH = "../asset/dataset/dataset.csv"
EXAM_DATASET_PATH = "../asset/dataset/exam_training_data.csv"
FINETUNED_MODEL_NAME = "Pathumma-llm-text-1.0.0-finetune-dataset-v1-exam-with-v1+exam-validation-set"
...
law_dataset = pd.concat((law_dataset, exam_data))
