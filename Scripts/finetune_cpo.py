...
import torch
import pandas as pd
from trl import ORPOConfig, ORPOTrainer, CPOConfig, CPOTrainer
...
MODEL_NAME_OR_PATH = "/project/lt200301-edubot/Capstone-TamTanai/models/SeaLLMs-v3-7B-Chat"
DATASET_PATH = "../asset/dataset/tamtanai_orpo_dataset.csv"
FINETUNED_MODEL_NAME = "SeaLLMs-v3-7B-Chat-finetune-v1-cpo"
...
#def process_dataset(data: pd.DataFrame):
 #   data["chosen"] = data["chosen_answer"]
 #   data["rejected"] = data["rejected_answer"]
  #  return data
...
#train_data = process_dataset(law_dataset)
...
log_df = pd.DataFrame(cpo_trainer.state.log_history)
try:
